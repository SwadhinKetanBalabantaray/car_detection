...
# Load the car cascade classifier (replace with your actual file path if different)
car_classifier_path = r'C:\Users\SWADHINKETAN\Documents\car detection\Haarcascades\haarcascade_car.xml'
...
# Video path (replace with your actual video file path)
video_path = r'C:\Users\SWADHINKETAN\Documents\car detection\PROJECT INTRODCUTION WITH CODE\4-video processing.html'
